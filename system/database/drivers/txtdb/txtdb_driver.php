<?php
namespace System\Database\Drivers\Txtdb;

use System\Database\Database;
use System\Database\Interfaces;

class Txtdb_driver extends Database implements Interfaces\Db_interface{
    ...
    public function __construct(array $config = []) {
        ...
        $this->set_db_dir($config['database']);
